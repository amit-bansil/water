...
@SuppressWarnings("unused") public class Transform3D {
    ...
    */
     ...
     */
     @SuppressWarnings("cast") public final void set(AxisAngle4f a1) {
   ...
   /**
     ...
     */
    @Deprecated public final void setNonUniformScale(double xScale,
					 double yScale,
					 double zScale) {
	if(scales == null)
	    scales = new double[3];
...
//	}
    ...
    @SuppressWarnings("null") private void svdReorder( double[] m, double[] t1, double[] t2, double[] rot,
