...
public final class KEWaterMolecule extends BallWaterMolecule{
        Material[] mats=new Material[3];
        
        KEWaterMolecule(IData d, int n){
            super(d,n,false); 
            for(int i=0;i<3;i++){
        ...
        private static float min=Float.POSITIVE_INFINITY ,max=Float.NEGATIVE_INFINITY;
        public void update(){
            super.update();
            ...
            for(int i=0;i<3;i++){
            	...
            	float f=data.getAtomKE(dRefNum,i);
