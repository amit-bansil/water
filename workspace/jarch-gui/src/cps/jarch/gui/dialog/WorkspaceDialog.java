...
public abstract class WorkspaceDialog<RT> {
	private static final MessageBundle dialogResources = MessageBundle
			.create(WorkspaceDialog.class);
	/**
	 * common resources for dialogs in WorkspaceDialog package 
	 * TODO put in separate class or even split up?
	 */
	static final MessageBundle getDialogResources() {
	...
	protected WorkspaceDialog(String name, MessageBundle res) {
