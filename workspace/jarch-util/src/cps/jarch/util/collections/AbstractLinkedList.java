...
public abstract class AbstractLinkedList implements List {
    ...
    @SuppressWarnings("unchecked") public Object[] toArray(Object[] array) {
     ...
     */
    @SuppressWarnings("unchecked") protected static class LinkedSubList extends AbstractList {
        /** The main list */
        ...
        @Override public boolean addAll(int index, Collection coll) {
            rangeCheck(index, size + 1);
            int cSize = coll.size();
            if (cSize == 0) {
                return false;
        ...
        @Override public Object set(int index, Object obj) {
            rangeCheck(index, size);
            checkModCount();
        ...
        @Override public List subList(int fromIndexInclusive, int toIndexExclusive) {
